...
extern struct lge_ddic_ops sw43402_ops;
extern struct lge_ddic_ops sw43408_ops;
...
void lge_ddic_feature_init(struct dsi_panel *panel)
{
	...
	if (panel->lge.use_mplus) {
		panel->lge.mplus_hd = LGE_MP_OFF;
		panel->lge.mp_max = LGE_MP_OFF;
		panel->lge.adv_mp_mode = LGE_MP_OFF;
		panel->lge.mp_mode = LGE_MP_OFF;
		panel->lge.cur_mp_mode = LGE_MP_NOR;
		panel->lge.mplus_dim_cnt = LGE_MPLUS_BR_DIM_CNT;
		panel->lge.mplus_dim_delay = LGE_MPLUS_BR_DIM_DELAY;
		/*rgb tune*/
		panel->lge.cm_preset_step = RGB_DEFAULT_PRESET;
		panel->lge.cm_red_step    = RGB_DEFAULT_RED;
		panel->lge.cm_green_step  = RGB_DEFAULT_BLUE;
		panel->lge.cm_blue_step   = RGB_DEFAULT_GREEN;
	}
...
char *lge_ddic_cmd_set_prop_map[LGE_DDIC_DSI_CMD_SET_MAX] = {
	"lge,mdss-dsi-ddic-mplus-command",
	...
	"lge,mplus-mode-set1-command",
	"lge,mplus-mode-set2-command",
	"lge,mplus-mode-set3-command",
...
char *lge_ddic_cmd_set_state_map[LGE_DDIC_DSI_CMD_SET_MAX] = {
	"lge,mdss-dsi-ddic-mplus-command-state",
	...
	"lge,mplus-mode-set1-command-state",
	"lge,mplus-mode-set2-command-state",
	"lge,mplus-mode-set3-command-state",
