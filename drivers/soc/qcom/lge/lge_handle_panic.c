...
#define CRASH_HANDLER_MAGIC_ADDR  0x4c
#define RAM_CONSOLE_ADDR_ADDR     0x50
#define RAM_CONSOLE_SIZE_ADDR     0x54
#define FB_ADDR_ADDR              0x58
#ifdef CONFIG_LGE_HANDLE_PANIC_RPMH_TIMEOUT
#define RPMH_TIMEOUT_STRING_ADDR  0x64
...
void lge_gen_key_panic(int key, int status)
{
	...
	if (debug_accessory_status) {
		ret = power_supply_get_property(usb,
...
static int gen_cdsp_panic(const char *val, struct kernel_param *kp)
{
